...
class ChangePasswordForm extends Model {
    ...
    public function rules()
    {
        return [
            ...
            ['newPassword', StrengthValidator::class,'preset'=>'normal','userAttribute'=>'username'],
    ...
    public function setPassword(){
        try {
            ...
            if(!$user->comparePasswords($this->newPassword)){
                ...
                $syncpass = isset(Yii::$app->params['system']['allowPassSync']) ? Yii::$app->params['system']['allowPassSync'] : false;
                $syncpass ? $user->setOperator() : null;
                return $user->save();
            } else {
