...
/**
 * This is the model class for table "policyversions".
 *
 * @property int $Id
...
class Policyversions extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['IdPolicy'], 'exist', 'skipOnError' => true, 'targetClass' => Policies::className(), 'targetAttribute' => ['IdPolicy' => 'Id']],
    ...
    {
        return $this->hasOne(Policies::className(), ['Id' => 'IdPolicy']);
    }
    ...
    {
        return $this->hasMany(Policyversions::className(), ['IdEarlierVersion' => 'Id']);
    }
    ...
    {
        $this->attachment = Attachments::find()
