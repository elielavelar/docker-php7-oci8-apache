...
use common\models\search\SettingdetailSearch;
...
class SettingController extends CustomController
{
    ...
    {
        $model = $this->findModel($id);
        $searchModel = new SettingdetailSearch();
        $searchModel->IdSetting = $model->Id;
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        
        $modelDetail = new Settingdetail();
        $modelDetail->IdSetting = $model->Id;
