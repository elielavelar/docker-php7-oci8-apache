...
/* @var $searchModel \common\models\Servicecentre */
...
$showInactive = false;
$showInactive ? array_push($states, Servicecentreservices::STATE_INACTIVE) : null;
?>
<div class="monitoring-index">
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-12">
                    <span class="float-left"><label class="small-info-box-icon" style="display: none" id="lbl_updatemessage"><i class='fas fa-refresh'></i> Actualizando Datos...</label></span>
                    <span class="float-right">&Uacute;ltima Actualizaci&oacute;n: <label class="small-info-box-icon" id="lbl_timelastupdate"></label></span>
                </div>
            </div>
        </div>
        <div class="card-body">
                    ...
                    foreach ($searchModel as $serv){
                        ...
                        . "<div class='card servicecentre' id='$serv->Id'>"
                                ...
                                foreach($serv->services as $service){
                                    echo in_array($service->state->Code, $states) ? "<div class='col-3 ". str_replace(' ', '_', $service->Code)."'>"
