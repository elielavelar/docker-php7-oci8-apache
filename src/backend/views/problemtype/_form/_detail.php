...
/* @var $modelDetail backend\models\Problemtypesolution */
/* @var $searchModel \backend\models\search\ProblemtypesolutionSearch; */
        ...
        <div class="row">
            <div class="col-12">
                <span class="float-left">
                    <?= $create ?
                        Html::button("<i class='fas fa-plus'></i> Agregar Solucion", ['class'=>'btn btn-success','id'=>'btn-add'])
                        :"";
                    ?>
                </span>
                <span class="float-right">
                    <?= $create ?
                        $this->render('_modalUploadBatch', ['model' => $modelDetail])
                        :"";
                    ?>
                </span>
            </div>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'content'=>function( $model){
                                return $model->Enabled == get_class($model)::ENABLED ? 'Sí' : 'No';
                            },
                            'enableSorting'=>TRUE
                        ],
                        'Description',
...
<?=$this->render('_modalSolution', ['model'=> $modelDetail])?>
<?php
$js = <<< JS
